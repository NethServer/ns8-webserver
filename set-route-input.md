...
| [port](#port)                           | `integer` | Optional | cannot be null | [set-route input](set-route-input-properties-port.md "http://schema.nethserver.org/traefik/set-route-input.json#/properties/port")                             |
...
Could be 7.4 or 8.0 or 8.1 or 8.2 or 8.3 or 8.4 or 8.5 or ''
